      ...
      <el-col :span="24">
        ...
        <el-col :span="16">
          <el-table :data="postlist" border style="width: 100%">
            ...
            <el-table-column label="操作" width="100x" v-if="postflag">
              <template slot-scope="scope" >
...
export default {
  ...
  methods: {
    ...
    getuser() {
      ...
      this.userinfo.id = _userinfo.stuId;
      this.userinfo.name = _userinfo.stuName;
      this.newpostinfo.postPresenterid = _userinfo.stuId;
      this.newpostinfo.postPresentername = _userinfo.stuName;
    },
    getmypost() {
      var params = {
        currentpagenum: this.CurrentpageNum,
    ...
    check(row) {
      if (
        row.commentPresenterid == this.userinfo.id &&
        row.commentPresentertype == 1
      ) {
        return true;
      } else {
        return false;
